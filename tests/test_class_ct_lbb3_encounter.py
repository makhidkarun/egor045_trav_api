        ...
        expected_dict = {
            ...
            'rows': {
                ...
                '10': {
                    'terrain': 'Clear',
                    'quantity': None,
                    'type': "Light seekers. About 40 large slug-like creatures are attracted to the band's lights, and crawl slowly towards them. They are poisonous, inflicting 2D hits per touch (50kg 10/2 S1)",
                    'weight': None,
                    'hits': None,
                    'wounds': None,
                    'weapons': None,
